        ...
        <div class="no-print">
            ...
            <form id="formEtiqueta">
                ...
                <div class="section">
                    ...
                    <div class="form-group"><label>A/C (Aos Cuidados de)</label><input type="text" id="dest_responsavel" value="{destinatario_padrao['responsavel']}" placeholder="Nome da pessoa que vai receber"></div>
