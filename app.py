...
def adicionar_orcamento():
        ...
        try:
            ...
            resp_cria = requests.post(f"{SUPABASE_URL}/rest/v1/servicos", 
                json={
                    ...
                    "valor_cobrado": 0.0,
                    "observacoes": f"Prazo: {prazo_dias} dias úteis após aprovação da arte. {observacoes_gerais}"
                }, headers=headers)
            
            if resp_cria.status_code != 201:
                print(f"❌ Erro ao criar orçamento: {resp_cria.status_code} - {resp_cria.text}")
            ...
            print(f"📦 Total de itens recebidos: {len(titulos)}")
            ...
            for i in range(len(titulos)):
                ...
                # Converte valores (aceita "27,55" ou "27.55")
                try:
                ...
                if resp_item.status_code != 201:
                    ...
                    print(f"    ✅ Item salvo com sucesso!")
            
            # 3. Atualiza valor total
            print(f"💰 Valor total do orçamento: R$ {vt:.2f}")
            ...
            if resp_patch.status_code == 204:
                ...
                print(f"⚠️ Erro ao atualizar valor total: {resp_patch.status_code}")
    ...
    .item-row {{ background: #f8f9fa; padding: 20px; margin: 15px 0; border-radius: 8px; border-left: 4px solid #3498db; }}
    .btn {{ padding: 12px 25px; background: #27ae60; color: white; border: none; border-radius: 5px; cursor: pointer; font-size: 16px; font-weight: bold; }}
    .btn-blue {{ background: #3498db; }}
    ...
    <body>
    <div class="container">
        <div class="header"><h1 style="margin:0;">➕ Novo Orçamento</h1></div>
        <div class="content">
                ...
                <div id="itens-container">
                    <div class="item-row">
                        <div class="grid" style="grid-template-columns: 2fr 1fr 1fr 1fr 1fr auto;">
                            ...
                            <div><label>Valor Unit. (R$) *</label><input type="text" name="item_valor_unit[]" placeholder="Ex: 300,50" required></div>
